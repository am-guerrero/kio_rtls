...
def talker():
    rospy.init_node('kio_rtls_String_talker', anonymous=True)
    ...
    pubOUTs = {}
    for tag in tags:
        pubOUTs[tag] = rospy.Publisher("/kio/String/"+tag+"/out", String, queue_size=10)
        ...
        try:
            ...
            if len(stdout) > 0:
                ...
                if data[0] == "003c":
                    ...
                    try:
                        pubOUTs[tagId].publish(String(stdout))
